...
public class DriverManagerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String type = request.getParameter("driver");
        ...
        if(type.equals("add")){
            ...
            lr.RegisterDriver(username, password, vehicleNo, con);
            
        } else if(type.equals("remove")){
            String name = request.getParameter("selected");
            Admin.removeDriver(name, con);
            Admin.removeDriverFromBooking(name, con);
